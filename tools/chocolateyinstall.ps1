...
$url64      = 'https://gitlab.com/librewolf-community/browser/windows/uploads/9fdc74485bca2525e903debc55443e14/librewolf-87.0.en-US.win64-setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'LibreWolf' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64    = '2D0FB86011D48EB1BB58EA3A9BFF382E138A08BBD4EAB23EE50F06E0551E444D'
